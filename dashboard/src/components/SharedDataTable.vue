...
const emit = defineEmits(['edit', 'delete', 'update:filters', 'update:rows', 'row-click']);
    ...
    >
      ...
      <Column class="w-16" :exportable="false">
        <template #body="slotProps">
            <Button icon="pi pi-ellipsis-v" text rounded @click="toggleMenu($event, slotProps.data)" aria-haspopup="true" aria-controls="overlay_menu" severity="secondary" />
        </template>
      </Column>
    </DataTable>
